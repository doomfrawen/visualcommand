...
**
** Created: Tue Jul 21 01:49:43 2009
...
static const char qt_meta_stringdata_DialogSearch[] = {
    "DialogSearch\0"
};

const QMetaObject DialogSearch::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DialogSearch,
      qt_meta_data_DialogSearch, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DialogSearch))
